        ...
        <article>
          ...
          <div className="my-8 p-5 bg-accent-50 border border-accent-100 rounded-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Link href="/guides/כמה-משכנתא-לפי-משכורת" className="flex items-center gap-2 text-sm text-primary-600 hover:text-primary-700 underline underline-offset-2 transition-colors duration-150">
                <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
