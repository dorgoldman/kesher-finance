  ...
  },
  {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'זו ההורדה החמישית של בנק ישראל תוך פחות משנה, אז המגמה ברורה, אבל לא מובטחת. כל החלטה נבחנת מחדש לפי נתוני האינפלציה והסיכון הגיאופוליטי, ואף אחד לא יודע בוודאות מה יוחלט בישיבה הבאה.',
        },
      },
      {
        '@type': 'Question',
    ...
    <div className="container-page py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-10">
        ...
        <article>
          ...
          <p className={p}>
            כיום, אחרי שבנק ישראל הוריד את הריבית חמש פעמים תוך פחות משנה, פריים 4.75%
            ומינוס 1.5% נותנים ריבית של 3.25%, בדיוק כמו בסוף 2022. ההחזר חוזר לכ-₪2,920.
          </p>
          <p className={p}>
            מ-₪1,920 ב-2021 ל-₪2,920 היום, גידול מצטבר של כ-52% בהחזר החודשי אחרי שהריבית
          ...
          <div className="space-y-4 mb-10">
            ...
            <div className="card">
              ...
              <p className="text-sm text-accent-500 leading-relaxed">
                זו ההורדה החמישית של בנק ישראל תוך פחות משנה, אז המגמה ברורה, אבל לא
