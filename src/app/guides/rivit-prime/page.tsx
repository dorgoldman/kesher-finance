    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'ריבית הפריים עומדת על 4.75% (נכון לספטמבר 2026, לאחר הורדת ריבית בנק ישראל ב-1.9.2026). היא מורכבת מריבית בנק ישראל (3.25%) ועוד 1.5% קבוע.',
        },
      },
      {
        '@type': 'Question',
        name: 'האם ריבית הפריים תרד עוד?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'זו ההורדה השלישית ברציפות של בנק ישראל תוך פחות משנה, אז המגמה ברורה, אבל לא מובטחת. כל החלטה נבחנת מחדש לפי נתוני האינפלציה והסיכון הגיאופוליטי, ואף אחד לא יודע בוודאות מה יוחלט בישיבה הבאה.',
        },
      },
      {
        '@type': 'Question',
        name: 'מתי ההחלטה הבאה של בנק ישראל על הריבית?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'הוועדה המוניטרית מתכנסת כשמונה פעמים בשנה, בערך כל שישה עד שמונה שבועות. התאריך המדויק של כל החלטה מתפרסם מראש בלוח הרשמי באתר בנק ישראל (boi.org.il).',
        },
      },
      {
        '@type': 'Question',
    ...
    <div className="container-page py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-10">
        ...
        <article>
          ...
          {/* Intro */}
          <p className={p}>
            ריבית הפריים היא ריבית הייחוס שקובעת את העלות של רוב ההלוואות והמשכנתאות
            בישראל, ומורכבת מריבית בנק ישראל (4.75%, נכון לספטמבר 2026) בתוספת 1.5%
            קבוע. אם יש לך מסלול פריים במשכנתא, כל שינוי בריבית בנק ישראל משנה ישירות
            את ההחזר החודשי שלך, בלי שום פעולה מצדך.
          </p>
          ...
          <p className={p}>
            כיום ריבית הפריים עומדת על 4.75% (ריבית בנק ישראל 3.25% פלוס 1.5% קבוע,
            נכון להורדת הריבית מ-1.9.2026). הבנקים לא ממציאים את הריבית שלהם. הם
            לוקחים את הפריים ומוסיפים עליו מרווח.
          </p>
          <p className={p}>
          ...
          <p className={p}>
            בינואר 2021, פריים עמד על 1.6%. אחרי המינוס: 0.1% בלבד. ההחזר החודשי: כ-₪2,025.
          </p>
          <p className={p}>
          ...
          <p className={p}>
            כיום, אחרי שבנק ישראל הוריד את הריבית שלוש פעמים ברציפות תוך פחות משנה, פריים 4.75%
            ומינוס 1.5% נותנים ריבית של 3.25%, בדיוק כמו בסוף 2022. ההחזר חוזר לכ-₪2,920.
          </p>
          <p className={p}>
            מ-₪2,025 ב-2021 ל-₪2,920 היום, גידול מצטבר של כ-44% בהחזר החודשי אחרי שהריבית
            עלתה לשיא וירדה בחזרה, ללא שום שינוי בגובה ההלוואה. מי שהגביל את הפריים ל-30%
            מהתמהיל ספג רק חלק מהתנודה הזאת, לא נוח בשיא, אבל ניהול אפשרי.
          </p>
          ...
          <div className="space-y-4 mb-10">
            <div className="card">
              ...
              <p className="text-sm text-accent-500 leading-relaxed">
                ריבית הפריים עומדת על 4.75% (נכון לספטמבר 2026, לאחר הורדת ריבית בנק
                ישראל ב-1.9.2026). היא מורכבת מריבית בנק ישראל (3.25%) ועוד 1.5% קבוע.
              </p>
            </div>

            <div className="card">
              <h3 className="font-bold text-accent-800 mb-2">האם ריבית הפריים תרד עוד?</h3>
              <p className="text-sm text-accent-500 leading-relaxed">
                זו ההורדה השלישית ברציפות של בנק ישראל תוך פחות משנה, אז המגמה ברורה, אבל לא
                מובטחת. כל החלטה נבחנת מחדש לפי נתוני האינפלציה והסיכון הגיאופוליטי, ואף
                אחד לא יודע בוודאות מה יוחלט בישיבה הבאה.
              </p>
            </div>

            <div className="card">
              <h3 className="font-bold text-accent-800 mb-2">מתי ההחלטה הבאה של בנק ישראל על הריבית?</h3>
              <p className="text-sm text-accent-500 leading-relaxed">
                הוועדה המוניטרית מתכנסת כשמונה פעמים בשנה, בערך כל שישה עד שמונה שבועות.
                התאריך המדויק של כל החלטה מתפרסם מראש בלוח הרשמי באתר בנק ישראל
                (boi.org.il).
              </p>
            </div>
