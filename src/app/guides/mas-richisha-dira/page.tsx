    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'בעת סגירת העסקה, כשאתה נרשם כבעל הדירה. צריך להחזיק את הכסף בכספיים מימי קביעת ההסכם.',
        },
      },
      {
        '@type': 'Question',
        ...
        <article>
          ...
          <div className="prose prose-sm max-w-none">
            ...
            <ol className="list-decimal list-inside space-y-2 mb-6">
              ...
              <li className={li}>בשנת 2026 המדרגות קפוצות עד ינואר 2028, ללא הצמדה</li>
            </ol>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className={p}>
                  בעת סגירת העסקה, כשאתה נרשם כבעל הדירה. צריך להחזיק את הכסף בכספיים מימי קביעת ההסכם.
                </p>
              </div>
