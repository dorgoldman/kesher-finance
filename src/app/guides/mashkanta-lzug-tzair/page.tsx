...
export const metadata: Metadata = {
  ...
  description: 'הלוואת זכאות היא ריבית מסובסדת למשכנתא. תנאי זכאות, מסלולים, ודוגמה מעשית מול משכנתא רגילה.',
  alternates: { canonical: CANONICAL },
  openGraph: {
    images: [OG_IMAGE],
    title: 'משכנתא לזוג צעיר: הלוואת זכאות ודיור פחות יקר',
    description: 'הלוואת זכאות היא ריבית מסובסדת למשכנתא. תנאי זכאות, מסלולים, ודוגמה מעשית.',
    url: CANONICAL,
    siteName: SITE_NAME,
    locale: 'he_IL',
    type: 'article',
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'לא ישירות. זכאות מנופקת בעת קנייה. אתה לא יכול "להחליף" משכנתא קיימת לזכאות: צריך למכור ולקנות דירה חדשה או למחול ולהתחיל הלוואה חדשה, מה שנדיר.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'לא. זכאות לא תרד את הזקיפה שלך למס או נקודות הזיכוי שלך. היא רק הנחה על ריבית.',
        },
      },
      {
        '@type': 'Question',
      ...
      <div className="container-page py-8 grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-8">
        <article className="prose prose-invert prose-rtl max-w-none">
          ...
          <p className="text-lg leading-relaxed mb-6">
            הפגישה בבנק נגמרה, ויש בידך שני מסלולים: משכנתא רגילה או משכנתא לזוג צעיר עם "תעודת זכאות" מממשרד הבינוי. המסלול השני מגיע בריבית מסובסדת (זולה יותר). אבל היא לא לכל אחד, והיא לא תמיד המסלול הכי משתלם. הנה הפרטים.
          </p>
          ...
          <ul className="list-disc list-inside space-y-2 mb-6 text-accent-600">
            <li>תעודת זכאות מורידה את ריבית המשכנתא <strong>בעד 0.5% לפחות</strong></li>
            <li>הריבית המקסימלית שתשלם בהלוואה מסובסדת היא <strong>3%</strong>, גם אם ריבית פריים של בנק ישראל היא גבוהה יותר</li>
            <li>תנאי זכאות: זוג בו שני בני הזוג מעל 35 שנים, או בעל/בעלת ביתו לא בעלי דירה קודמת (נכון ל-2026)</li>
            <li>בתכניות מסוימות צריך "ניקוד" של לפחות 599 נקודות (תעודת זכאות מהבנק)</li>
            <li>בדוגמה מעשית, ההפרש בין משכנתא רגילה למסובסדת הוא <strong>₪30,000–70,000 על 20 שנה</strong>: תלוי בריבית הפריים הנוכחית</li>
          </ul>

          <h2 className="text-2xl font-bold mt-8 mb-4">מה זו תעודת זכאות?</h2>
          <p className="text-accent-600 mb-4">
            הממשלה הישראלית מסבסדת חלק מהמשכנתאות: כלומר היא לוקחת על עצמה חלק מהריבית כדי להפוך דיור לזול יותר לצעירים ולזוגות צעירים. התעודה היא הזיהוי שלך כקנוי דירה שזכאי להנחה הזו.
          </p>
          <p className="text-accent-600 mb-6">
            הזכאות לא אוטומטית. היא תלוייה בגיל, בעדר רכוש קודם, ובתנאים מסוימים, ובקבלה מהבנק. זה בדיוק כמו ניקוד קרדיט למסלולי משכנתא רגילה.
          </p>
            ...
            <table className="w-full border-collapse text-sm text-right">
              ...
              <tbody>
                <tr className="bg-accent-50/60 border-b">
                  ...
                  <td className="px-4 py-2">לפחות זוג שבו שני בני הזוג מעל 35 שנים, או בעל/בעלת ביתו צעיר (עד 45) שלא היה לו דירה קודמת</td>
                </tr>
                <tr className="border-b">
                  <td className="px-4 py-2">ניקוד זכאות</td>
                  <td className="px-4 py-2">ציון 599 ויותר בתעודת זכאות, שמנפקת הבנק</td>
                </tr>
                <tr className="bg-accent-50/60 border-b">
                  <td className="px-4 py-2">דירה ראשונה</td>
                  <td className="px-4 py-2">מחסן/אולם לא מחוייב; דירה ראשונה בלבד (לא רכישת דירה שלישית וכו&apos;)</td>
                </tr>
                <tr className="border-b">
                  <td className="px-4 py-2">מחיר מקסימלי</td>
                  <td className="px-4 py-2">התנאים שונים למחוזות, אבל תקרה של ~₪2,000,000–2,500,000 בממוצע</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p className="text-accent-600 mb-6">
            הבנק בודק את הנקודות שלך בדומה לנקודות משכנתא רגילה: הכנסה, יחס החזר/הכנסה, היסטוריה אשראי. אם יש לך ניקוד גבוה למשכנתא רגילה, בדרך כלל יש לך גם ניקוד גבוה לזכאות.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4">מה ההבדל: הלוואת זכאות מול משכנתא רגילה?</h2>
          <p className="text-accent-600 mb-6">
            כאן הנקודה הגדולה. משכנתא רגילה: הבנק מחליט על הריבית, וזה תלוי בפריים. הלוואת זכאות: הממשלה קובעת "ריבית דיור" משלה, שנמוכה מהפריים. ההבדל הוא בעדך.
          </p>
          ...
          <div className="bg-accent-50/40 rounded-xl p-6 mb-6">
            ...
            <p className="font-bold text-sm mb-2">תרחיש 1: משכנתא בריבית משתנה (פריים + סקוד)</p>
            <ul className="text-sm space-y-1 mb-4 text-accent-600">
              <li>ריבית הפריים כיום היא 5.0%</li>
              <li>סקוד שהבנק לוקח: 1.5%</li>
              <li>סה"כ: 6.5%</li>
            ...
            <p className="text-xs text-accent-500 mt-4 italic">
              חישוב זה משתמש בנוסחת הריבית המורכבת הסטנדרטית עבור הלוואות צמודות מדד (amortization formula). הקצבים 5.0% וריבית דיור 3% הם נכונים ליולי 2026 על פי בנק ישראל.
            </p>
          </div>

          <p className="text-accent-600 mb-6">
            זה הסיבה שעולות שיחות על תעודות זכאות: האחסכון הוא ממשי מאוד.
          </p>

          <h2 className="text-2xl font-bold mt-8 mb-4">האם הלוואת זכאות זהה בכל בנק?</h2>
          <p className="text-accent-600 mb-4">
            לא בדיוק. כל בנק יכול להוסיף "סקוד" משלו גם על הלוואת זכאות (עמלה לא תלויה בריבית בנק ישראל). אחד הבנקים יכול לתת זכאות בריבית 3% טהור (כלומר ריבית דיור בלבד), ובנק אחר יוסיף 0.3% סקוד. זה עדיין יותר זול מהחלופה הרגילה, אבל זה שונה מבנק לבנק.
          </p>
          <p className="text-accent-600 mb-6">
            בדוק עם חמישה בנקים לפחות, כי ההבדל בסקוד יכול להיות <strong>₪100+ בחודש</strong>.
          </p>

          <CalculatorCTA
            calculatorName="מחשבון משכנתא לזוג צעיר"
            calculatorUrl="/tools/young-couple-mortgage"
            teaser="השווה בין משכנתא רגילה, קבועה, ותעודת זכאות. כל פעם שתשנה סכום או תקופה המחשבון יעדכן."
          />
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-accent-600">
                לא ישירות. זכאות מנופקת בעת קנייה. אתה לא יכול "להחליף" משכנתא קיימת לזכאות: צריך למכור ולקנות דירה חדשה (או למחול ולהתחיל הלוואה חדשה, מה שנדיר).
              </p>
            </div>
            <div>
              <p className="font-bold mb-2">האם זכאות משפיעה על מס?</p>
              <p className="text-accent-600">
                לא. זכאות לא תרד את הזקיפה שלך למס או נקודות הזיכוי שלך. היא רק הנחה על ריבית.
              </p>
            </div>
            <div>
