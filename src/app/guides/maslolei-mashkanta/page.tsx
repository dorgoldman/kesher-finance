    ...
    <div className="container-page py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-10">
        ...
        <article>
          ...
          <p className={p}>
            מסלול פריים צמוד לריבית הפריים, שנקבעת על ידי בנק ישראל ומתעדכנת בכל שינוי ריבית שהוועדה המוניטרית מכריזה עליו. לפי בנק ישראל, נכון לספטמבר 2026 (אחרי הורדת הריבית מ-1.9.2026), ריבית בנק ישראל עומדת על 3.25% וריבית הפריים על 4.75% (ריבית בנק ישראל ועוד 1.5% קבוע).
          </p>
          <p className={p}>
          ...
          <p className={p}>
            זה לא רק עניין של טעם אישי. לפי הוראת ניהול בנקאי תקין 329 של בנק ישראל, החלק המשתנה במשכנתא, כלומר פריים ומשתנה כל 5 שנים ביחד, לא יכול לעלות על שני שלישים מסך ההלוואה. לפחות שליש חייב להיות במסלול שאינו משתנה, בדרך כלל קבועה.
          </p>
          <p className={p}>
