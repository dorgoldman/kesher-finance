...
const jsonLd = [
  ...
  /* 3. FAQPage */
  {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: 'אני מרוויח פחות מ-16,150 ₪ בחודש. תיקון 288 בכלל רלוונטי לי?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'לא ישירות. מדרגות ה-10% וה-14% לא זזו, אז אם כל המשכורת שלך נופלת שם, המס שלך זהה למה שהיה ב-2025. השינוי משפיע רק על מי שחלק מההכנסה שלו נופל בין 16,150 ל-25,100 ₪.',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'תלוי כמה מהמשכורת שלך נופל בטווח 16,150-25,100 ₪ ובכמה נקודות זיכוי יש לך. הדרך הכי מהירה לקבל מספר מדויק היא להזין את המשכורת שלך במחשבון השכר נטו ולראות את הפירוט המלא.',
        },
      },
    ],
  },
    ...
    <div className="container-page py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-10">
        ...
        <article>
          ...
          {/* ── Intro ── */}
          <p className={p}>
            ₪204. זה בערך כמה יותר נשאר לך בכיס כל חודש אם אתה מרוויח 18,000 ₪
            ברוטו, בזכות שינוי שנכנס לתוקף בתחילת 2026 ורוב האנשים לא שמו לב אליו.
          </p>
          <p className={p}>
            מדרגות מס הכנסה 2026 עצמן זזו, בתיקון 288. מי שמרוויח בין 16,150
          ...
          <ul className="list-none space-y-2.5 mb-8">
            {[
              'מדרגת 20% הורחבה מ-16,150 ₪ ל-19,000 ₪ לחודש, ומדרגת 31% זזה ל-19,001-25,100 ₪, לפי תיקון 288.',
              ...
              'על משכורת של 18,000 ₪ ברוטו, ההפרש הוא כ-204 ₪ בחודש, כ-2,442 ₪ בשנה.',
              'שווי נקודת זיכוי ל-2026 הוא 242 ₪ לחודש, ולא השתנה בתיקון.',
              'מי שכל המשכורת שלו מתחת ל-16,150 ₪ לא מרגיש שום הבדל.',
            ].map((item, idx) => (
          ...
          <p className={p}>
            תיקון 288 לפקודת מס הכנסה הרחיב את מדרגת ה-20% מתקרה של 16,150 ₪
          ...
          <p className={p}>
            <span className={strong}>לפי המדרגות הישנות</span> (20% עד 16,150 ₪,
            31% אחרי כך): ₪701 על ה-7,010 ₪ הראשונים, ₪427 על הפלח הבא של
            3,050 ₪, ₪1,218 על הפלח שנפל במדרגת ה-20% הישנה (6,090 ₪), ועוד
            ₪573.5 על ה-1,850 ₪ שנפלו כבר במדרגת ה-31%. סך הכל: ₪2,919.5.
          </p>
          <p className={p}>
          ...
          <p className={p}>
            ההפרש: כ-₪204 בחודש, כ-₪2,442 בשנה. באותה משכורת בדיוק, בלי לעבוד
            שעה נוספת.
          </p>
          ...
          <div className="space-y-4 mb-10">
            <div className="card">
              <h3 className="font-bold text-accent-800 mb-2">
                אני מרוויח פחות מ-16,150 ₪ בחודש. תיקון 288 בכלל רלוונטי לי?
              </h3>
              <p className="text-sm text-accent-500 leading-relaxed">
                ...
                שחלק מההכנסה שלו נופל בין 16,150 ל-25,100 ₪.
              </p>
            </div>
            ...
            <div className="card">
              ...
              <p className="text-sm text-accent-500 leading-relaxed">
                תלוי כמה מהמשכורת שלך נופל בטווח 16,150-25,100 ₪ ובכמה נקודות
