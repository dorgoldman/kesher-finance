...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'אודות מקסיט',
    description:
      'Maxit היא פלטפורמת כלים ומדריכים פיננסיים בעברית. מחשבונים מדויקים, מדריכים ברורים, בלי שטויות.',
    url: CANONICAL,
    siteName: SITE_NAME,
    locale: 'he_IL',
    type: 'website',
  ...
  return (
    <div className="container-page py-10">
      ...
      <div className="max-w-2xl">
        ...
        <p className={p}>
          Maxit היא פלטפורמת כלים ומדריכים פיננסיים בעברית, שנבנתה עבור כל מי שרוצה
        ...
        <p className={p}>
          Maxit היא מיזם של MGH Venture Studio, סטודיו לפיתוח ותפעול עסקים המתמחה
