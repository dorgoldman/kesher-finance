  ...
  return (
    <div className="container-page py-10">
      ...
      <div className="max-w-2xl">
        ...
        <p className={p}>
          Maxit.מקסיט היא פלטפורמת כלים ומדריכים פיננסיים בעברית, שנבנתה עבור כל מי שרוצה
        ...
        <p className={p}>
          Maxit.מקסיט היא מיזם של MGH Venture Studio, סטודיו לפיתוח ותפעול עסקים המתמחה
