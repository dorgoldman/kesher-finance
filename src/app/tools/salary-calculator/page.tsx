  ...
  /* 3. FAQPage */
  {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'מדרגות מס הכנסה לשנת 2026 (חודשי): עד ₪7,270 — 10%; ₪7,271–₪10,420 — 14%; ₪10,421–₪16,720 — 20%; ₪16,721–₪23,150 — 31%; ₪23,151–₪48,130 — 35%; ₪48,131–₪61,990 — 47%; מעל ₪61,990 — 50%. המדרגות מתעדכנות מדי שנה.',
        },
      },
      {
        '@type': 'Question',
